...
AI is a gimmick and I think most features that have resulted from it so far are borderline unusable and unreliable. Looked from a different perspective when you are either ok with unreliability or WANT unreliability (like emulating a human), then it's actually usable. It's pretty cool for visual stuff, mainly photos right now and I think in that direction it can become quite impressive. Maybe this opinion will age like milk, who knows.
