  ...
  return (
    <div className="flex flex-row w-full justify-between font-motiva-sans">
      <div className="flex flex-col">
        ...
        <p className="ml-3 text-colorPrimary"> {item.repo} </p>
      </div>
      <Link
        href={item.git}
        className="flex items-center text-black bg-accentGreen px-5 py-2 rounded-md hover:bg-hoverAccentGreen font-medium mr-3"
      >
